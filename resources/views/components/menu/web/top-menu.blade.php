<nav x-data="{ mobileMenuIsOpen: false }" @click.away="mobileMenuIsOpen = false" id="navBar"
     class="bg-white sm:fixed sm:z-40 sm:w-full flex items-center justify-between
     border-b border-neutral-300 sm:px-32 tracking-wider
     px-6 py-4 dark:border-neutral-700 text-gray-800"
     aria-label="penguin ui menu">
    <!-- Brand Logo -->
    <a href="#" class="text-2xl font-bold gap-4 inline-flex items-center">
        <span>

            <x-logo.aaran brand="aaran" class="w-auto h-10 block"/>

        </span>
        <span class="hover:scale-110 duration-300 transition-all ease-out">
            AARAN
        </span>
    </a>
    <!-- Desktop Menu -->
